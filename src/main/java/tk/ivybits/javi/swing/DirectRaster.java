 ...
 * in the Raster class.
 */
public class DirectRaster extends Raster {
     ...
     *  @throws java.awt.image.RasterFormatException if computing either
     *          <code>origin.x + sampleModel.getWidth()</code> or
     *          <code>origin.y + sampleModel.getHeight()</code> results
     *          in integer overflow
     */
    protected DirectRaster(SampleModel sampleModel,
                             Point origin) {
        this(sampleModel,
     ...
     * @throws java.awt.image.RasterFormatException if <code>aRegion</code> has width
     ...
     *          <code>null</code>.
     */
    public DirectRaster getWritableParent() {
        return (DirectRaster)parent;
    }
     ...
     *         overflow
     */
    public DirectRaster createWritableTranslatedChild(int childMinX,
                                                        int childMinY) {
     ...
     * @exception java.awt.image.RasterFormatException if the subregion is outside of the
     *                               raster bounds.
     * @throws java.awt.image.RasterFormatException if <code>w</code> or
     *         <code>h</code>
     ...
     *         overflow
     */
    public DirectRaster createWritableChild(int parentX, int parentY,
                                              int w, int h,
     ...
     * {@link DirectRaster#setRect(Raster)}.
     *
